                    ...
                    <div id="animal-Information">
                   	<div id="animal-Information-1" style="overflow: hidden">
                           <div class="slide-container">
                               <div class="slide-box">
                                    <img id="titleImg" src="https://jmva.or.jp/wp-content/uploads/2018/07/noimage.png">
	     						</div>
                               <div class="slide-box">
                                   <img id="contentImg1" src="https://jmva.or.jp/wp-content/uploads/2018/07/noimage.png">
                               </div>
                               <div class="slide-box">
                                   <img id="contentImg2" src="https://jmva.or.jp/wp-content/uploads/2018/07/noimage.png">
                               </div>
                               <div class="slide-box">
                                   <img id="contentImg3" src="https://jmva.or.jp/wp-content/uploads/2018/07/noimage.png">
                               </div>
                               <div class="slide-box">
                                   <img id="contentImg4" src="https://jmva.or.jp/wp-content/uploads/2018/07/noimage.png">
                               </div>
                           </div>
                   	</div>
 				...
 				<script>
                	...
                	function loadImg(inputFile, num){
               		  if (inputFile.files.length == 1) {
							...
							switch(num){
									case 1 : $("#titleImg").attr("src", "https://jmva.or.jp/wp-content/uploads/2018/07/noimage.png"); break;
									case 2 : $("#contentImg1").attr("src", "https://jmva.or.jp/wp-content/uploads/2018/07/noimage.png"); break;
									case 3 : $("#contentImg2").attr("src", "https://jmva.or.jp/wp-content/uploads/2018/07/noimage.png"); break;
									case 4 : $("#contentImg3").attr("src", "https://jmva.or.jp/wp-content/uploads/2018/07/noimage.png"); break;
									case 5 : $("#contentImg4").attr("src", "https://jmva.or.jp/wp-content/uploads/2018/07/noimage.png"); break;
							};
						};
                	}
                </script>
