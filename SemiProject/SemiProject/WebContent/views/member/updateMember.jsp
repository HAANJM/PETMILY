						...
						<div id="enroll-member-form-wrap">
                            ...
                            <div class="enroll-row">
                                ...
                                <div class="enroll-col-2-type-1 enroll-col-2-type-2">
                                    <input type="number" name="phoneF" maxlength="4" oninput="inputNumberMaxLength(this);" onkeyup="checkPhone();" value="<%= phoneF %>" required>
                                  <!--  <select name="phoneF" required>
                                    ...
                                    &#45;
                                    &nbsp;
                                    <input type="number" name="phoneM" maxlength="4" oninput="inputNumberMaxLength(this);" onkeyup="checkPhone();" value="<%= phoneM %>" required>
                                    &nbsp;
                                    &#45;
                                    &nbsp;
                                    <input type="number" name="phoneB" maxlength="4" oninput="inputNumberMaxLength(this);" onkeyup="checkPhone();" value="<%= phoneB %>" required>
                                </div>
                            ...
                            <div class="enroll-row address-row">
                                ...
                                <div class="enroll-col-2-type-3">
                                    <input type="text" id="sample6_postcode" name="postcode" placeholder="우편번호" value="<%= postcode %>" readonly required>
                                    &nbsp;<button onclick="sample6_execDaumPostcode();">우편번호 찾기</button><br><br>
                                    <input type="text" id="sample6_address" name="addressMain" placeholder="주소" value="<%= addressMain %>" readonly required><br><br>
                                    <input type="text" id="sample6_detailAddress" name="addressDetail" placeholder="상세주소" value="<%= addressDetail %>" required>
                                    <input type="text" id="sample6_extraAddress" name="addressAdd" placeholder="참고항목" value="<%= addressAdd %>" readonly>
                                </div>
                            </div>
